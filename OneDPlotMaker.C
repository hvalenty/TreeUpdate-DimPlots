...
//void Proton(){
    ...
    float mean, rms;
FILE *fp = fopen("/work/clas12/fatiha/Spring2019-Depol-Eloss-QA.txt","r");
...
outTree->Draw("de>>mx2xf");
mx2xf->Draw("COLZ");

gPad->Modified();
gPad->Update();

c01162->Print("OneDim-de.png");
